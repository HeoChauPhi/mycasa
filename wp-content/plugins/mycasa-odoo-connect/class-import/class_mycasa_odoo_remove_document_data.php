...
if ( class_exists( 'WP_Batch' ) ) {
	/**
	 * Class MyCasaOdooRemoveDocument
	 */
	class MyCasaOdooRemoveDocument extends WP_Batch {

		/**
		 * Unique identifier of each batch
		 * @var string
		 */
		public $id = 'mycasa_to_odoo_remove_document';

		/**
		 * Describe the batch
		 * @var string
		 */
		public $title = 'Mycasa remove Document';
	 ...
	 */
	function mycasa_remove_document_batch_processing_init() {
		$batch_remove_document = new MyCasaOdooRemoveDocument();
		WP_Batch_Processor::get_instance()->register( $batch_remove_document );
	}

	add_action( 'wp_batch_processing_init', 'mycasa_remove_document_batch_processing_init', 20, 1 );
}
