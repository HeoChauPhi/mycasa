...
if ( class_exists( 'WP_Batch' ) ) {
  class MyCasaOdooRemoveProperties extends WP_Batch {
    /**
     * Unique identifier of each batch
     * @var string
     */
    public $id = 'mycasa_to_odoo_remove_properties';

    /**
     * Describe the batch
     * @var string
     */
    public $title = 'Mycasa remove Properties (Appartment)';
   ...
   */
  function mycasa_remove_properties_batch_processing_init() {
    $batch = new MyCasaOdooRemoveProperties();
    WP_Batch_Processor::get_instance()->register( $batch );
  }

  add_action( 'wp_batch_processing_init', 'mycasa_remove_properties_batch_processing_init', 24, 1 );
}
