			...
			<div class="modal-content">
				...
				<div class="modal-body clearfix">
					<div class="lightbox-gallery-wrap <?php echo esc_attr($lightbox_class); ?>">
						...
						<?php } elseif ( !empty(get_field('gallery_upload')) ) { ?>
						<div class="lightbox-gallery">
					    <div id="lightbox-slider-js" class="lightbox-slider">
					        
				        <?php
				        foreach( get_field('gallery_upload') as $prop_image_meta ) {
				       		$output = '';
			            $output .= '<div>';
					        $output .= '<img class="img-fluid" src="'.esc_url( $prop_image_meta ).'" alt="'.get_the_title().'" title="'.get_the_title().'">';
							    $output .= '</div>';
						...
						<?php } elseif ( !empty(get_field('gallery_url')) ) { ?>
						<div class="lightbox-gallery">
					    <div id="lightbox-slider-js" class="lightbox-slider">
					        
				        <?php
				        foreach( get_field('gallery_url') as $prop_image_meta ) {
				       		$output = '';
			            $output .= '<div>';
					        $output .= '<img class="img-fluid" src="https://adztvetajq.cloudimg.io/'.esc_url( $prop_image_meta['picture_attachement_ids'] ).'" alt="'.get_the_title().'" title="'.get_the_title().'">';
							    $output .= '</div>';
